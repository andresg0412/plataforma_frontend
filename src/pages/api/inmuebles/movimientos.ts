...
// Data mock para movimientos por inmueble y fecha
const mockMovimientosPorInmueble: { [key: string]: { [fecha: string]: IMovimiento[] } } = {
  '1': {
    '2024-10-08': [
      {
        id: 'MOV-001',
      ...
      },
      {
        ...
        id_empresa: '1',
        fecha_creacion: '2024-10-08T14:15:00.000Z',
        fecha_actualizacion: '2024-10-08T14:15:00.000Z'
      },
      {
        id: 'MOV-003',
        fecha: '2024-10-08',
